(function() {
  ...
  ns.UserSettings = {
    ...
    EXPORT_INCLUDE_GRID: 'EXPORT_INCLUDE_GRID',
    EXPORT_HIDE_IMAGE: 'EXPORT_HIDE_IMAGE',
    SHOW_CELL_COUNTER: 'SHOW_CELL_COUNTER',
    ...
    KEY_TO_DEFAULT_VALUE_MAP_: {
      ...
      SHOW_CELL_COUNTER: true,
      EXPORT_INCLUDE_GRID: true,
      EXPORT_HIDE_IMAGE: false,
    },
  ...
  ns.UserSettings.migrate_to_v0_12 = function() {
    var storedGridEnabled = ns.UserSettings.readFromLocalStorage_(
      'GRID_ENABLED'
    );
    if (
      typeof storedGridEnabled === 'undefined' ||
      storedGridEnabled === null
    ) {
