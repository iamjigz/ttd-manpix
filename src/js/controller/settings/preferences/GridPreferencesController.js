(function() {
  ...
  function applyI18n() {
    pskl.utils.applyI18nDOM('.preferences-panel-grid .bg-picker label');
    pskl.utils.applyI18nDOM(
      '.preferences-panel-grid .enable-grid label > span'
    );
    pskl.utils.applyI18nDOM(
      '.preferences-panel-grid .settings-item-grid-size label'
    );
    pskl.utils.applyI18nDOM(
      '.preferences-panel-grid .settings-item-grid-spacing label'
    );
    pskl.utils.applyI18nDOM(
      '.preferences-panel-grid .settings-item-grid-color label'
    );
  }
